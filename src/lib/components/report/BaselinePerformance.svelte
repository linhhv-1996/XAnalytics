...
<div class="card-soft p-4">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
        <div>
            <div class="text-slate-500 text-[10px] uppercase mb-1 font-medium">Typical Views</div>
        ...
        <div>
            <div class="text-slate-500 text-[10px] uppercase mb-1 font-medium">Typical Likes</div>
        ...
        <div>
            <div class="text-slate-500 text-[10px] uppercase mb-1 font-medium">Engagement</div>
        ...
        <div>
            <div class="text-slate-500 text-[10px] uppercase mb-1 font-medium">Viral Odds</div>
